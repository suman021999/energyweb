...
const Trusty = () => {
  ...
  const companyImages = {
    'Shell':'/energyWeb/Shell.png',
    'Deloitte': '/energyWeb/Deloitte.png',
    'STEDIN': '/energyWeb/Stedin.png',
    'CarbonEnfo': '/energyWeb/carbonenf.png',
    'eDF': '/energyWeb/edf.png',
    'electra': '/energyWeb/electra.png',
    'Aventus': '/energyWeb/AVENTUS.png',
    'ella group': '/energyWeb/Elia_group.png',
    'ENGIGE': '/energyWeb/engic.png',
    'Deutsche ERDWÄRME': '/energyWeb/dutsche.png',
    'FOTON': '/energyWeb/Foton.png',
    'MERELECI': '/energyWeb/merelec.png',
    'AUSTIN': '/energyWeb/austin.png',
    'STW': '/energyWeb/stw.png',
    'acciona': '/energyWeb/acciona.png',
    'inavitas': '/energyWeb/inavitas.png',
    'equinor': '/energyWeb/eqinor.png',
    'OSQ': '/energyWeb/qsq.png',
    'verv': '/energyWeb/verv.png',
    'Brookfield': '/energyWeb/brookfield.png',
    'SCYTALE': '/energyWeb/scytale.png',
  };

...
import arrow from "/arrow.svg"; // arrow import
...
const data = [
  {
    ...
    img: "/Transition/Transition1.png",
  },
  {
    title: "Aviation",
  ...
  },
  {
    ...
    img: "/Transition/Transition4.png",
  },
];
        ...
        {data.map((item, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-white/80 to-transparent p-4 flex flex-col justify-center">
              <h3 className="text-[3rem] font-semibold px-4 font-[font1]">
                {item.title}
              </h3>
